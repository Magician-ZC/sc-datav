...
export default function Footer(props: ComponentProps<typeof Wrapper>) {
  const { mode, bgMode, bar, tooltipAlwaysShow, toggle, toggleBgMode } = useConfigStore();
  ...
  return (
    <Wrapper {...props}>
      ...
      <Buttons>
        ...
        {/* 背景切换按钮 - 星空/浅色 */}
        <Button $active={bgMode === "starry"} onClick={toggleBgMode}>
          <svg
            fill="currentColor"
            viewBox="0 0 1024 1024"
            width="24"
            height="24">
            <path d="M512 74.666667c-241.066667 0-437.333333 196.266667-437.333333 437.333333s196.266667 437.333333 437.333333 437.333333 437.333333-196.266667 437.333333-437.333333-196.266667-437.333333-437.333333-437.333333z m0 810.666666c-206.165333 0-373.333333-167.168-373.333333-373.333333s167.168-373.333333 373.333333-373.333333 373.333333 167.168 373.333333 373.333333-167.168 373.333333-373.333333 373.333333z m149.333333-373.333333a149.333333 149.333333 0 1 1-298.666666 0 149.333333 149.333333 0 0 1 298.666666 0z"></path>
          </svg>
        </Button>
        ...
        {/* 面板信息显示/隐藏按钮 */}
        <Button $active={tooltipAlwaysShow} onClick={() => toggle("tooltipAlwaysShow")} title={tooltipAlwaysShow ? "点击隐藏面板信息" : "点击显示面板信息"}>
          <svg
            fill="currentColor"
            viewBox="0 0 1024 1024"
            width="24"
            height="24">
            <path d="M864 160H160c-35.2 0-64 28.8-64 64v512c0 35.2 28.8 64 64 64h704c35.2 0 64-28.8 64-64V224c0-35.2-28.8-64-64-64z m0 576H160V224h704v512zM256 320h512v64H256z m0 128h384v64H256z m0 128h256v64H256z"></path>
          </svg>
        </Button>
      </Buttons>
    </Wrapper>
